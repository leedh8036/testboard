...
require_once (dirname(__FILE__).'/../../../../../lib/ucp/logic/main/common/ModifyProfile.php');
...
$modify_profile = new ModifyProfile($_REQUEST, $auth_user->getAccountExternal());

if(!$modify_profile->start()) {
	finish($auth_service->getData(), $auth_user->getData(), $modify_profile->getResultSet());
}
